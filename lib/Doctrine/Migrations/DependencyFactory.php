...
class DependencyFactory
{
    ...
    public function getConnection(): Connection
    {
        if ($this->connection === null) {
            $this->connection = $this->connectionLoader->getConnection($this->getConfiguration()->getConnectionName());
            $this->freeze();
        }
    ...
    public function getVersionComparator(): Comparator
    {
        return $this->getDependency(
            Comparator::class,
            static function (): AlphabeticalComparator {
    ...
    public function getClassNameGenerator(): ClassNameGenerator
    {
        return $this->getDependency(
            ...
            static function (): ClassNameGenerator {
    ...
    {
        return $this->getDependency(
            SchemaDiffProvider::class,
            function (): SchemaDiffProvider {
    ...
    public function getMigrationsFinder(): MigrationFinder
    {
        return $this->getDependency(
            ...
            function (): MigrationFinder {
                ...
                $needsRecursiveFinder = $configs->areMigrationsOrganizedByYear(
                    ) || $configs->areMigrationsOrganizedByYearAndMonth();
    ...
    public function getMigrationStatusCalculator(): MigrationStatusCalculator
    {
        return $this->getDependency(
            ...
            function (): MigrationStatusCalculator {
    ...
    public function getMigrationPlanCalculator(): MigrationPlanCalculator
    {
        return $this->getDependency(
            ...
            function (): MigrationPlanCalculator {
    ...
    {
        return $this->getDependency(
            MigratorConfigurationFactory::class,
            function (): MigratorConfigurationFactory {
    ...
    {
        return $this->getDependency(
            MigrationStatusInfosHelper::class,
            function (): MigrationStatusInfosHelper {
